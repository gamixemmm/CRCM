...
const navItems: { labelKey: TranslationKey; href: string; icon: LucideIcon; permissions?: string[]; adminOnly?: boolean }[] = [
  ...
  { labelKey: "nav.invoices", href: "/invoices", icon: FileText, permissions: ["VIEW_ALL_INVOICES", "VIEW_UNPAID_INVOICES", "MANAGE_INVOICES"] },
  { labelKey: "nav.expenses", href: "/expenses", icon: TrendingDown, permissions: ["VIEW_EXPENSES", "MANAGE_EXPENSES", "VIEW_DASHBOARD_FINANCIALS"] },
  { labelKey: "nav.carInstallments", href: "/car-installments", icon: WalletCards, permissions: ["VIEW_CAR_PAYMENTS", "ADD_CAR_PAYMENTS"] },
